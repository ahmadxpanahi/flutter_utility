                    ...
                    Container(
                      child: Column(
                        children: <Widget>[
                          ...
                          Transform(
                            transform: Matrix4.translationValues(0, changeState == 'minute' ? animation.value * (isSlideForward ? 50 : -50) : 0, 0),
                            child: Opacity(
                              opacity: changeState == 'minute' ? 1 - animation.value : 1,
                              child: Text(
                                initMinute.toString(),
                                style: TextStyle(
                                  fontSize: 40,
                                  color: isDisable ? Colors.grey.withOpacity(0.5) : Colors.grey,
                                ),
                              ),
                            ),
                          ),
                    ...
                    Container(
                      child: Column(
                        children: <Widget>[
                          ...
                          Transform(
                            transform: Matrix4.translationValues(0, changeState == 'hour' ? animation.value * (isSlideForward ? 50 : -50) : 0, 0),
                            child: Opacity(
                              opacity: changeState == 'hour' ? 1 - animation.value : 1,
                              child: Text(
                                initHour.toString(),
                                style: TextStyle(
                                  fontSize: 40,
