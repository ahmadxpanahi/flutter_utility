...
class _PersianYearPickerState extends State<PersianYearPicker> with TickerProviderStateMixin {
    ...
    List<Widget> yearList = years.map((year) {
      ...
      return GestureDetector(
        ...
        child: Container(
          ...
          child: Container(
            padding: EdgeInsets.all(3),
            decoration: BoxDecoration(color: initDate.year == year ? Colors.white : Colors.transparent, borderRadius: BorderRadius.all(Radius.circular(50))),
            child: Center(
              child: Text(
                '$year',
    ...
    return Directionality(
      ...
      child: Column(
        children: <Widget>[
          ...
          Transform(
              transform: Matrix4.translationValues(animation.value * (isSlideForward ? 300 : -300), 0, 0),
              child: Opacity(
                  opacity: 1 - animation.value,
                  child: Container(
