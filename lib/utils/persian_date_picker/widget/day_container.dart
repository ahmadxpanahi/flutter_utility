...
import 'package:utilities/utils/persian_date_picker/utils/consts.dart';
import 'package:utilities/utils/persian_date_picker/utils/date.dart';
...
class DayContainer extends StatefulWidget {
  ...
  DayContainer({this.date, this.startDate, this.endDate, this.onSelect, this.height, this.width});
...
class _DayContainerState extends State<DayContainer> {
  ...
  Widget build(BuildContext context) {
    ...
    bool isBetween = isValid && date > widget.startDate && date < widget.endDate;
      ...
      child: date != ''
          ? Container(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(color: isStart || isEnd ? Colors.white : Colors.transparent, borderRadius: BorderRadius.all(Radius.circular(50))),
                child: Center(
                  child: Text(
                    date != '' ? date.formatter.d : '',
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 14, color: isDisable ? Colors.grey : Colors.black, fontWeight: FontWeight.w300),
                  ),
                ),
              ),
            )
